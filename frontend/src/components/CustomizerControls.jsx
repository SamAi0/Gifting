...
import { Type, Image as ImageIcon, Trash2, Palette, AlertCircle, RefreshCcw, Plus, Pipette, MessageSquare, ShoppingBag } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col h-full gap-10">
      ...
      <div className="space-y-6">
        <h3 className="text-sm font-black text-slate-800 uppercase tracking-widest border-b border-slate-100 pb-2">1. Branding Assets</h3>
      ...
      {/* SECTION 2: DESIGN */}
      <div className="space-y-6">
        <h3 className="text-sm font-black text-slate-800 uppercase tracking-widest border-b border-slate-100 pb-2">2. Personalize Design</h3>
      ...
      {/* SECTION 3: DESIGN INSTRUCTIONS */}
      <div className="space-y-6">
        <h3 className="text-sm font-black text-slate-800 uppercase tracking-widest border-b border-slate-100 pb-2">3. Design Instructions</h3>
        
        <section className="space-y-3">
          <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest flex items-center gap-2">
            <MessageSquare size={12} className="text-primary" /> Special Requests & Notes
          </label>
          <textarea
        ...
        <div className="flex gap-3">
          <button
            onClick={onReset}
            className="px-4 py-4 bg-slate-100 text-slate-400 rounded-xl hover:bg-slate-200 transition-all"
            title="Reset All"
          >
            <RefreshCcw size={14} />
          </button>
          <button
            ...
            className="flex-1 btn-primary py-4 text-xs font-bold shadow-xl shadow-primary/20 flex items-center justify-center gap-3"
          >
            <ShoppingBag size={14} />
