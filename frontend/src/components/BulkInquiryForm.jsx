...
const BulkInquiryForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await submitBulkInquiry(payload);
      setStatus('success');
      setFormData({
        fullName: '',
        email: '',
      ...
      console.error('Failed to submit bulk inquiry:', error);
      setStatus('error');
    }
  };
  ...
  return (
    <section className="py-12 md:py-20 bg-slate-50 relative overflow-hidden" id="bulk-inquiry">
      {/* Abstract Background */}
      ...
      <div className="container-home relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="bg-white rounded-[2rem] p-6 md:p-8 shadow-premium border border-slate-100">
            <h3 className="text-2xl font-bold text-slate-900 mb-2">Bulk Inquiries Tailored to Your Needs</h3>
            ...
            {status === 'success' ? (
              <div className="bg-green-50 text-green-700 p-6 rounded-2xl border border-green-100 text-center">
                ...
                <p className="text-sm">We have received your inquiry. Our corporate team will contact you shortly.</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                {status === 'error' && (
                  <p className="text-red-500 text-xs font-bold">Failed to submit inquiry. Please try again or use WhatsApp.</p>
                )}
